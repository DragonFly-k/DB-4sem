...
begin catch
print 'Номер ошибки: ' + cast(error_number() as varchar(6));	print 'Сообщение: ' + error_message();
...
declare SUBJECTS_L12 cursor for
...
exec PAUDITORIUM_INSERTX @AUD = '323-1', @NAME = '323-1', 
@CAPACITY = 50, @AUD_TYPE = 'ЛР-К', @AUD_TYPENAME = 'Лаб'
